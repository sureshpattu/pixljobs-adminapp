Handlebars.registerPartial("job_card_row", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"panel main_card_sec js_main_card_sec\">\n        <div class=\"panel-heading\">\n            <div class=\"row\">\n                <div class=\"col-md-9\">\n                    <a data-toggle=\"collapse\" class=\"panel-title collapsed js_panel_title\"\n                       data-parent=\"#accordion\"\n                       href=\"#collapse_"
    ...
    + ",</span>\n                        </div>\n                    </a>\n                </div>\n                <div class=\"col-md-3\">\n                    <div class=\"cta_wrap\">\n                        <a class=\"btn btn_blue\">Publish</a>\n                        <a class=\"btn btn_red\">Reject</a>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div id=\"collapse_"
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    ...
    + ((stack1 = helpers.each.call(alias1,((stack1 = (depth0 != null ? depth0.company : depth0)) != null ? stack1.company_benefits : stack1),{"name":"each","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"cta_wrap\">\n                    <a class=\"btn btn_blue\">Publish</a>\n                    <a class=\"btn btn_red\">Reject</a>\n                </div>\n            </div>\n        </div>\n    </div>\n";
...
Handlebars.registerPartial("notification_card_row", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"panel main_card_sec js_main_card_sec\">\n        <div class=\"panel-heading\">\n            <div class=\"row\">\n                <div class=\"col-md-9\">\n                    <a data-toggle=\"collapse\" class=\"panel-title collapsed js_panel_title\"\n                       data-parent=\"#accordion\"\n                       href=\"#collapse_"
    ...
    + "\">\n                        <div class=\"title_sec\">\n                            <span class=\"highlights\">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</span>\n                            <span class=\"small_txt\">status rejected</span>\n                            <img src=\"/img/icons/arrow-down-small.svg\" alt=\"\" class=\"icon_arrow_down\">\n                            <div class=\"small_txt trunc_txt\">the is the description foe the text</div>\n                        </div>\n                    </a>\n                </div>\n            </div>\n        </div>\n        <div id=\"collapse_"
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    + "\" class=\"panel-collapse collapse\">\n            <div class=\"panel-body\">\n                <div class=\"job_card\">\n                    <div class=\"job_sec\">\n                        <div class=\"job_tags\">\n\n                        </div>\n                    </div>\n                </div>\n                <div class=\"cta_wrap\">\n                    <a class=\"btn btn_blue\">Publish</a>\n                    <a class=\"btn btn_red\">Reject</a>\n                </div>\n            </div>\n        </div>\n    </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;
