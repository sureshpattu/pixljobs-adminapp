Handlebars.registerPartial("job_card_row", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"panel main_card_sec js_main_card_sec\" data-job-id=\""
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.qa_job_requirements : depth0),{"name":"each","hash":{},"fn":container.program(12, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                                    </ul>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"tech_details\">\n                        <div class=\"tech_sec\">\n                            <div class=\"desc_title\">\n                                Technologies\n                            </div>\n                            <div class=\"desc\">\n                                <div class=\"row\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.qa_job_technologies : depth0),{"name":"each","hash":{},"fn":container.program(14, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    ...
    + ((stack1 = helpers.each.call(alias1,((stack1 = (depth0 != null ? depth0.company : depth0)) != null ? stack1.company_benefits : stack1),{"name":"each","hash":{},"fn":container.program(21, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"cta_wrap\">\n"
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias2).call(alias1,(depth0 != null ? depth0.status : depth0),"===","published",{"name":"ifCond","hash":{},"fn":container.program(23, data, 0),"inverse":container.program(25, data, 0),"data":data})) != null ? stack1 : "")
    + "                    <a class=\"btn btn_big js_reject_job\" data-type=\"rejected\">Reject</a>\n                </div>\n            </div>\n        </div>\n    </div>\n";
  ...
  return "                                        <div class=\"col-md-6\">\n                                            <div class=\"row\">\n                                                <div class=\"col-md-6 col-xs-6\">\n                                                    <div class=\"tech_name\">"
    ...
    + "</div>\n                                                </div>\n                                                <div class=\"col-md-6 col-xs-6\">\n"
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias2).call(alias1,(depth0 != null ? depth0.level : depth0),"===","Basic",{"name":"ifCond","hash":{},"fn":container.program(15, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias2).call(alias1,(depth0 != null ? depth0.level : depth0),"===","Proficient",{"name":"ifCond","hash":{},"fn":container.program(17, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias2).call(alias1,(depth0 != null ? depth0.level : depth0),"===","Expert",{"name":"ifCond","hash":{},"fn":container.program(19, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                                                </div>\n                                            </div>\n                                        </div>\n";
  ...
  return "                                        <div class=\"col-md-6\">\n                                            <div class=\"circle_wrap\">\n                                                <div class=\"circle_tick\">\n                                                    <img src=\"/img/icons/tick.svg\" class=\"icons tick\">\n                                                </div>\n                                                <div class=\"title\">"
    ...
    return "                        <a class=\"btn btn_blue btn_big js_unpublish_job\" data-type=\"pending\">Un-publish</a>\n";
},"25":function(container,depth0,helpers,partials,data) {
    return "                        <a class=\"btn btn_blue btn_big js_publish_job \" data-type=\"published\">Publish</a>\n";
},"27":function(container,depth0,helpers,partials,data) {
    return "    <h4 class=\"text-center text-capitalize\">NO DATA FOUND!</h4>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(27, data, 0),"data":data})) != null ? stack1 : "");
},"useData":true}));
...
Handlebars.registerPartial("notification_card_row", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"panel main_card_sec js_main_card_sec\">\n        <div class=\"panel-heading\">\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <label class=\"check_box check_notifications\">\n                        <input type=\"checkbox\" class=\"js_check_notification\" value=\""
    ...
    + "\">\n                        <div class=\"title_sec\">\n                            <span class=\"highlights\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.qa_job : depth0)) != null ? stack1.name : stack1), depth0))
    + "</span>\n\n                            <img src=\"/img/icons/arrow-down-small.svg\" alt=\"\" class=\"icon_arrow_down\">\n                            "
    + ((stack1 = (helpers.truncateText || (depth0 && depth0.truncateText) || alias4).call(alias3,(depth0 != null ? depth0.msg : depth0),20,{"name":"truncateText","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n\n                        </div>\n                    </a>\n                </div>\n            </div>\n        </div>\n        <div id=\"collapse_"
    + alias2(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"index","hash":{},"data":data}) : helper)))
    + "\" class=\"panel-collapse collapse\">\n            <div class=\"panel-body\">\n                <div class=\"job_card\">\n                    <div class=\"job_sec\">\n                        <div class=\"job_tags\">\n                            <span class=\"small_txt\">"
